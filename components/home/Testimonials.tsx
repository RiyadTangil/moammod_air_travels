const TESTIMONIALS = [
  { initials: 'RK', name: 'Rahim Karim', role: 'Businessman, Chittagong', stars: 5, quote: 'Indian visa approved in just 4 days! The team at Mohammad Air International Travels handled everything professionally. No hidden charges, very honest service. Highly recommended for anyone needing visa assistance.' },
  { initials: 'JH', name: 'Jamal Hossain', role: 'Factory Owner, Gazipur', stars: 5, quote: 'I sent 3 workers to Malaysia through Mohammad Air International Travels. The whole process — medical, visa, flight — was handled smoothly. My workers got jobs safely and are doing great. Trust them 100%.' },
  { initials: 'FA', name: 'Fatema Akter', role: 'Teacher, Sylhet', stars: 5, quote: 'Our Umrah package was excellent. Hotel was close to Haram, flights on time, and the group guide was very knowledgeable. Mohammad Air International Travels made our spiritual journey truly unforgettable.' },
  ...
  { initials: 'NK', name: 'Nasreen Khan', role: 'HR Manager, Dhaka', stars: 5, quote: 'Best air ticket prices in Dhaka! Booked 5 tickets to Dubai for my team through Mohammad Air International Travels. They provided all airline choices and we got a great deal. Will definitely use again.' },
];
